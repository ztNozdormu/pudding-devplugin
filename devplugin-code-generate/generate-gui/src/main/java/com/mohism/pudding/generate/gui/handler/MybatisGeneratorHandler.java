...
import com.mohism.pudding.generate.gui.plugins.DbRemarksCommentGenerator;
...
public class MybatisGeneratorHandler {
	...
	private static final Logger _LOG = LoggerFactory.getLogger(MybatisGeneratorHandler.class);
    ...
    public MybatisGeneratorHandler() {
    }
